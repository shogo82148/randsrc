/*
Package xoroshiro1024ss implements xoroshiro1024** 1.0, one of our all-purpose, rock-solid,
...
//
// Go port of http://prng.di.unimi.it/xoroshiro1024starstar.c
type Source struct {
	state [16]uint64
	p     int
}
