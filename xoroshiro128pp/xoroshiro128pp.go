/*
Package xoroshiro128pp implements xoroshiro128++ 1.0, one of our all-purpose, rock-solid,
...
func (s *Source) Uint64() uint64 {
	...
	s1 ^= s0
	s0 = bits.RotateLeft64(s0, 49) ^ s1 ^ (s1 << 21) // a, b
	s1 = bits.RotateLeft64(s1, 28)                   // c
